...
public class CatIngresosDet implements Serializable {

    private String id_ing, id_det, id_art, id_bod, id_ubi, det_lot, fec_ven, det_can, nomart,nombod,nomubi;

    public CatIngresosDet() {
    }

    public CatIngresosDet(String id_ing, String id_det, String id_art, String id_bod, String id_ubi, String det_lot, String fec_ven, String det_can, String nomart, String nombod, String nomubi) {
        this.id_ing = id_ing;
        this.id_det = id_det;
        this.id_art = id_art;
        this.id_bod = id_bod;
