...
public class CatEntregas implements Serializable {

    private String cod_tra, cod_det, cod_bod, cod_ubi, cod_art, det_lot, fec_ven, det_can, nombod, nomubi, nomart, det_can_con, uni_med_con, det_cos, codrefart, nomunimed, sol_mae, sol_det;

    public CatEntregas() {
    }

    public CatEntregas(String cod_tra, String cod_det, String cod_bod, String cod_ubi, String cod_art, String det_lot, String fec_ven, String det_can, String nombod, String nomubi, String nomart, String det_can_con, String uni_med_con, String det_cos, String codrefart, String nomunimed, String sol_mae, String sol_det) {
        ...
        this.sol_mae = sol_mae;
        this.sol_det = sol_det;
    }
    ...
    public String getSol_mae() {
        return sol_mae;
    }

    public void setSol_mae(String sol_mae) {
        this.sol_mae = sol_mae;
    }

    public String getSol_det() {
        return sol_det;
    }

    public void setSol_det(String sol_det) {
        this.sol_det = sol_det;
    }
