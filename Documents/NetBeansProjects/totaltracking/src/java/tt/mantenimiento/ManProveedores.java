...
public class ManProveedores implements Serializable {
    ...
    public void llenarPaises() {
        try {
            ...
            System.out.println("Error en el llenado de Paises en Catálogo de Fabricantes. " + e.getMessage());
        }
    }
    ...
    public void llenarProveedores() {
        ...
        try {
            ...
            mQuery = "select cod_pro,cod_pai,nom_pro,per_con,tel_con,det_mai,flg_pro_pie  "
                    + "from cat_pro where flg_pro_pie =" + flagpropie + " order by cod_pro;";
            ResultSet resVariable;
            ...
            System.out.println("Error en el llenado de Catálogo Fabricantes. " + e.getMessage() + " Query: " + mQuery);
        }
    }
    ...
    public boolean validardatos() {
        ...
        macc.Conectar();
        if ("0".equals(macc.strQuerySQLvariable("select count(cod_pro) from cat_pro "
        ...
        if (validardatos()) {
            try {
                ...
                if ("".equals(cod_pro)) {
                    ...
                    mQuery = "insert into cat_pro (cod_pro,cod_pai,nom_pro,per_con,tel_con,det_mai,flg_pro_pie) "
                ...
                System.out.println("Error al Guardar Fabricantes. " + e.getMessage() + " Query: " + mQuery);
            }
            llenarProveedores();
        }
        nuevo();
    ...
    public boolean validareliminar() {
        ...
        macc.Conectar();
        if (!macc.strQuerySQLvariable("select count(cod_pro) from lis_equ where cod_pro = " + cod_pro + ";").equals("0")) {
            mvalidar = false;
            addMessage("Delete", "This Manufacturer has associated Equipment", 2);
        }
        macc.Desconectar();
    ...
    public void eliminar() {
        ...
        if (validareliminar()) {
            try {
                ...
                System.out.println("Error al Eliminar Fabricantes. " + e.getMessage() + " Query: " + mQuery);
            }
            llenarProveedores();
            nuevo();
        }
